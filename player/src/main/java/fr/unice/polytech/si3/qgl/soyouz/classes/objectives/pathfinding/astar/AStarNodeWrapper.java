package fr.unice.polytech.si3.qgl.soyouz.classes.objectives.pathfinding.astar;
...
public class AStarNodeWrapper<N extends Comparable<N>> implements Comparable<AStarNodeWrapper<N>>
{
    ...
    public AStarNodeWrapper(N node, AStarNodeWrapper<N> predecessor, double totalCostFromStart, double minimumRemainingCostToTarget)
    {
        this.node = node;
